...
export const Hero = () => {
  ...
  return (
    <section className="grid place-content-center place-items-center mb-12 md:mb-24">
      <div className="flex ">
        <div className="ellipse2 absolute -left-[10%] -top-32"></div>
        <div className="ellipse3 absolute left-[25%] -top-32"></div>
        <div className="ellipse2 absolute left-[50%] -top-32"></div>
        <div className="ellipse3 absolute right-[10%] -top-32"></div>
      </div>
      ...
      <div className="bg-primary text-black w-screen py-1 mt-4 flex justify-around relative z-0">
        <div className="float w-full flex justify-evenly">
          {Fields.map((item) => (
            <span className="text-sm md:text-xl grid grid-flow-col items-center gap-6 ">
              <svg
                width="13"
                height="13"
                viewBox="0 0 12 12"
        ...
        <div className="w-auto border-2 border-primary rounded-[2rem] text-primary bg-[rgb(21_20_20)] absolute top-1/2  -translate-y-1/2 z-30">
          <h1 className="text-2xl md:text-6xl uppercase p-4 md:p-7 ">
            get early access
          </h1>
        </div>
      </div>
